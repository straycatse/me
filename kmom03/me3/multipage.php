...
$pages = [
    ...
    "entries-server" => [
        "title" => "Räknar innehållet i  \$_SERVER variabeln.",
        "file" => __DIR__ . "/$base/entries-server.php",
    ],
    "length-server" => [
        "title" => "Räknar längden på innehållet i  \$_SERVER variabeln.",
        "file" => __DIR__ . "/$base/length-server.php",
    ],
];
